...
import { ArrowLeft, Lightbulb, Sprout, Utensils, Volume2, Warehouse } from "lucide-react";
...
const donationUsage = [
  {
    ...
    amount: 4500000,
    total: 10000000,
    description: "Securing the perfect location for our events."
  },
  {
    category: "Sound & Audio Equipment",
    icon: Volume2,
    amount: 3200000,
    total: 5000000,
    description: "Ensuring crystal-clear audio for performances and talks."
  },
  {
    category: "Lighting & Staging",
    icon: Lightbulb,
    amount: 2500000,
    total: 4000000,
    description: "Creating an immersive atmosphere with professional lighting."
  },
  {
    ...
    amount: 6000000,
    total: 7500000,
    description: "Providing refreshments and meals for guests and staff."
  },
  {
    category: "Artist & Performer Fees",
    icon: Sprout,
    amount: 8800000,
    total: 12000000,
    description: "Supporting the talented individuals who make our events special."
  }
];
...
export default function DonationUsagePage() {
  const totalRaised = donationUsage.reduce((acc, item) => acc + item.amount, 0);
  const totalGoal = donationUsage.reduce((acc, item) => acc + item.total, 0);
    ...
    <AuthenticatedLayout>
      <div className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <Card className="shadow-lg mb-8">
            <CardHeader>
                <CardTitle className="font-headline text-3xl">Where Your Money Goes</CardTitle>
                <CardDescription>We believe in full transparency. Here’s a breakdown of how donations are supporting our events. Click on a category to see a detailed graph.</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="space-y-4">
                    <div className="text-center">
                        <p className="text-lg font-bold">Total Raised: INR {totalRaised.toLocaleString('en-IN')}</p>
                        <p className="text-sm text-muted-foreground">Goal: INR {totalGoal.toLocaleString('en-IN')}</p>
                    </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
            {donationUsage.map((item, index) => (
                <Link key={index} href={`/donation/usage/${slugify(item.category)}`} className="block hover:scale-105 transition-transform duration-300">
                    <Card className="h-full">
                        ...
                        <CardContent>
                            ...
                            <Progress value={(item.amount / item.total) * 100} className="mb-2" />
                            <p className="text-xs text-right font-semibold">
                                INR {item.amount.toLocaleString('en-IN')} / INR {item.total.toLocaleString('en-IN')}
                            </p>
                        </CardContent>
                    </Card>
                </Link>
...
// import { CreditCard, Heart, Smartphone, Info, History } from "lucide-react";
// import Link from "next/link";
...
//             <h1 className="font-headline text-4xl font-bold mt-4">Support Our Events</h1>
//             <p className="text-muted-foreground mt-2">
//                 Your contributions help us create amazing experiences. Every donation makes a difference!
//             </p>
//         </div>
...
//             <CardDescription>Choose an amount and your preferred payment method.</CardDescription>
//           </CardHeader>
//           <CardContent className="grid gap-6">
//             <div className="grid grid-cols-3 gap-4">
//                 <Button variant="outline">INR 500</Button>
//                 <Button variant="outline">INR 1,000</Button>
//                 <Button variant="accent">INR 2,500</Button>
//             </div>
//             <div className="grid gap-2">
//                 <Label htmlFor="amount">Or enter a custom amount (INR)</Label>
//                 <Input id="amount" type="number" placeholder="e.g., 1500" />
//             </div>
//              <div className="space-y-4">
...
//             <Button size="lg" className="w-full font-bold" variant="accent">
...
//                 <Link href="/donation/usage-chart">
