      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <p className="mt-4 text-muted-foreground text-sm">Seamlessly book event seats and hotel stays. Your next experience is just a click away.</p>
          </div>

          <div>
            <h3 className="font-headline text-lg font-semibold text-foreground">Quick Links</h3>
            <nav className="mt-4 flex flex-col space-y-2 text-sm">
              <Link href="/about" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">About Us</Link>
              ...
              <Link href="/faq" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">FAQ</Link>
            </nav>
          </div>
